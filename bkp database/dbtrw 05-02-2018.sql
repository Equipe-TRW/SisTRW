...
--
-- Host: 127.0.0.1
-- Generation Time: 06-Fev-2018 às 12:26
...
INSERT INTO `tbl_categorias` (`id_cat`, `nome_cat`, `desc_cat`) VALUES
(1, 'teste', 'teste'),
(2, 'BibsFiha', 'asdasdas'),
(3, 'McDonalds', 'asdasdas'),
(4, 'Burguer Kings', 'adasdas');
...
(23, 'Rafael Angolano', NULL, 'Feminino', '(24)22222-2222', '(22)22222-2222', 'rafael@angola.com.br', '55.555.555-5', '555.555.555-55', '13179072', 'SP', 'Sumaré', 'Jardim Minezotta (Nova Veneza)', 'Rua Denilson de Oliveira', 24),
...
(17, 'Administrador', 'admin', 'admin', 'Adm', 80000, '444444333', '444443323'),
(18, 'Elisandra', 'eli', '123', 'Operador de Caixa', 1300, '4564564', '546456'),
(19, 'Elivelton', 'elivelton', '123', 'estoque', 1800, '4654654', '456456');
