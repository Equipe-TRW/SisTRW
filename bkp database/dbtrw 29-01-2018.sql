...
--
-- Host: 127.0.0.1
-- Generation Time: 30-Jan-2018 às 02:01
...
CREATE TABLE `tbl_privilegio` (
  ...
  `status_privilegio` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(3, 'dfgfdgdfg', 'fdgfdgfdgdfg', '123', 'fvgfdgdfg', 1000, '46932786885', '5454964'),
(4, 'Rafael Correa Mateus', 'rafael', '123', 'CEO', 100000, '12345678995', '586989657');
